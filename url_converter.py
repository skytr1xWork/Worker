...
def _setup_cookies_from_env():
    ...
    # Method 1: Full cookies file (base64 encoded)
    ...
    if sapisid:
        ...
        try:
            ...
            # SAPISID is the most important for API access
            cookie_content = f"""# Netscape HTTP Cookie File
# This file was generated by yt-dlp. Do not edit.

.youtube.com	TRUE	/	TRUE	{int(time.time()) + 94608000}	SAPISID	{sapisid}
.youtube.com	TRUE	/	FALSE	{int(time.time()) + 94608000}	__Secure-1PAPISID	{sapisid}
.youtube.com	TRUE	/	TRUE	{int(time.time()) + 94608000}	__Secure-3PAPISID	{sapisid}
"""
            with open(cookie_path, "w") as f:
                f.write(cookie_content)
            logger.info(f"YouTube SAPISID cookie configured → {cookie_path}")
        except Exception as e:
            logger.warning(f"Failed to setup SAPISID: {e}")
